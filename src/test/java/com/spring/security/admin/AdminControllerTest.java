package com.spring.security.admin;
...
class AdminControllerTest {
    ...
    public void setUp(@Autowired WebApplicationContext applicationContext) {
        ...
        user = userRepository.save(new User("user", "user", GenderType.MALE, 22, "ROLE_USER"));
        // ROLE_ADMIN 권한이 있는 관리자 생성
        admin = userRepository.save(new User("admin", "admin", GenderType.MALE, 22, "ROLE_ADMIN"));
    }
