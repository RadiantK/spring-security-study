...
class NoteControllerTest {
    ...
    public void setUp(@Autowired WebApplicationContext applicationContext) {
        this.mockMvc = MockMvcBuilders.webAppContextSetup(applicationContext)
                ...
                .alwaysDo(print())
                .build();
        user = userRepository.save(new User("user123", "user", GenderType.MALE,22, "ROLE_USER"));
        admin = userRepository.save(new User("admin123", "admin",  GenderType.MALE,22, "ROLE_ADMIN"));
    }
