...
public class StudentManager implements AuthenticationProvider, InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        Set.of(
                new Student("hong", "홍길동", Set.of(new SimpleGrantedAuthority("ROLE_STUDENT")), "lee"),
                new Student("kang", "강감찬", Set.of(new SimpleGrantedAuthority("ROLE_STUDENT")), "lee"),
                new Student("jang", "장보고", Set.of(new SimpleGrantedAuthority("ROLE_STUDENT")), "lee")
